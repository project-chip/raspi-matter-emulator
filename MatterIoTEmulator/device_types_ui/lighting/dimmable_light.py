...
class DimmableLight(BaseDeviceUI):
    """
    DimmableLight device UI controller represent some attribues, clusters
    and endpoints corresspoding to Matter Specification v1.2
    """

    def __init__(self, parent) -> None:
        """
        Create a new `DimmableLight` UI.
        :param parent: An UI object load DimmableLight device UI controller.
        """
